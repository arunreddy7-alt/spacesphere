          ...
          <div style={{ 
            ...
            <div className="floating-card" style={{
              ...
              <div style={{ marginTop: '18px' }}>
                ...
                <p style={{ fontSize: '14px', color: '#4a4a4a', lineHeight: '1.5', margin: 0 }}>
                  Hand-picked projects that balance lifestyle, connectivity, and long–term value.
                </p>
              </div>
            </div>
            ...
            <div className="floating-card" style={{
              ...
              <div style={{ marginTop: '20px' }}>
                ...
                <p style={{ fontSize: '14px', color: '#4a4a4a', lineHeight: '1.5', margin: 0 }}>
                  Verified numbers, realistic projections, and complete price transparency at every step.
                </p>
              </div>
            </div>
            ...
            <div className="floating-card" style={{
              ...
              <div style={{ marginTop: '20px' }}>
                ...
                <p style={{ fontSize: '14px', color: '#4a4a4a', lineHeight: '1.5', margin: 0 }}>
                  From shortlist to site visit to signing — one dedicated team streamlining your journey.
                </p>
              </div>
            </div>
            ...
            <div className="floating-card central-card" style={{
              gridArea: 'card5',
              background: 'linear-gradient(135deg, #c79a4a 0%, #d4b774 100%)',
              padding: '24px 22px',
              borderRadius: '18px',
              boxShadow: '0 22px 60px rgba(199, 154, 74, 0.4)',
              ...
              <div>
                <h3 style={{ fontSize: '20px', fontWeight: 700, color: '#ffffff', marginBottom: '10px', fontFamily: "'Playfair Display', serif" }}>
                  Space Sphere Edge
                </h3>
                <p style={{ fontSize: '15px', color: 'rgba(255, 255, 255, 0.9)', lineHeight: '1.6', margin: 0 }}>
                  A boutique advisory approach that blends deep market  </p>
              </div>
            </div>
          </div>
