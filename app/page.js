            ...
            <div className="hero-main">
              <div className="hero" style={{ 
                ...
                <h1 className="hero-heading" style={{ 
                  ...
                  fontSize: 'clamp(4.5rem, 8vw + 2rem, 7.5rem)',
                  fontWeight: 700,
                  letterSpacing: '0.1em',
                  marginBottom: '30px',
                  textAlign: 'center',
                ...
                <div className="hero-cta-row" style={{ 
                  ...
                  <button
                    ...
                    style={{
                      ...
                      cursor: 'pointer',
                      transition: 'all 0.4s cubic-bezier(0.4, 0, 0.2, 1)',
                      boxShadow: '0 10px 30px rgba(0, 0, 0, 0.25), 0 0 30px rgba(199, 154, 74, 0.1)',
                      position: 'relative',
                      overflow: 'hidden',
                      textTransform: 'uppercase'
                    }}
                    onMouseEnter={(e) => {
                      ...
                      e.target.style.transform = 'translateY(-3px) scale(1.03)';
                      e.target.style.boxShadow = '0 15px 40px rgba(0, 0, 0, 0.35), 0 0 50px rgba(199, 154, 74, 0.2)';
                    }}
                    onMouseLeave={(e) => {
                      e.target.style.borderColor = 'rgba(255, 255, 255, 0.35)';
                      e.target.style.transform = 'translateY(0) scale(1)';
                      e.target.style.boxShadow = '0 10px 30px rgba(0, 0, 0, 0.25), 0 0 30px rgba(199, 154, 74, 0.1)';
                    }}
                  >
                ...
                <div style={{
                  ...
                  boxShadow: '0 0 20px rgba(199, 154, 74, 0.08)'
                }} />
                <div style={{
                  position: 'absolute',
                  bottom: '12%',
                ...
                <div style={{
                  ...
                  boxShadow: '0 0 25px rgba(199, 154, 74, 0.08)'
                }} />
