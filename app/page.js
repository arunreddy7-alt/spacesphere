...
<section className="space-sphere-edge-section" style={{ padding: '80px 0', position: 'relative', overflow: 'hidden', background: '#ffffff', color: '#ffffff' }}>
  {/* Geometric Background Elements */}
  <div style={{ position: 'absolute', top: '-50px', right: '-50px', width: '250px', height: '250px', background: 'radial-gradient(circle, rgba(199, 154, 74, 0.08) 0%, transparent 70%)', borderRadius: '50%', zIndex: 1 }}></div>
  <div style={{ position: 'absolute', bottom: '-25px', left: '-25px', width: '200px', height: '200px', background: 'conic-gradient(from 0deg, rgba(199, 154, 74, 0.06) 0deg, transparent 120deg, rgba(199, 154, 74, 0.08) 240deg, transparent 360deg)', zIndex: 1, animation: 'rotate 20s linear infinite' }}></div>

  {/* Floating Geometric Shapes */}
  <div style={{ position: 'absolute', top: '20%', left: '10%', width: '50px', height: '50px', background: 'linear-gradient(45deg, rgba(199, 154, 74, 0.1), rgba(199, 154, 74, 0.05))', transform: 'rotate(45deg)', borderRadius: '8px', zIndex: 1, animation: 'float 6s ease-in-out infinite' }}></div>
  <div style={{ position: 'absolute', bottom: '25%', right: '15%', width: '40px', height: '40px', background: 'linear-gradient(135deg, rgba(199, 154, 74, 0.12), rgba(199, 154, 74, 0.08))', borderRadius: '50%', zIndex: 1, animation: 'float 8s ease-in-out infinite reverse' }}></div>

  <div style={{ maxWidth: '1400px', margin: '0 auto', padding: '0 24px', position: 'relative', zIndex: 2 }}>
    <div style={{ textAlign: 'center', marginBottom: '50px' }}>
      <h2 className="about-hero-title">The Space Sphere Edge</h2>
      <h4 className="office-subheading"> Because Luxury Deserves Precision. </h4>
    </div>
    ...
    >
      ...
      <div className="floating-card" style={{ background: 'linear-gradient(135deg, #ffffff 0%, #fefefe 100%)', padding: '45px 38px', borderRadius: '22px', boxShadow: '0 18px 45px rgba(0, 0, 0, 0.1), 0 10px 25px rgba(199, 154, 74, 0.2)', border: '1px solid rgba(199, 154, 74, 0.25)', position: 'relative', transform: 'translateY(0)', transition: 'all 0.4s cubic-bezier(0.4, 0, 0.2, 1)', zIndex: 3, gridColumn: '2', gridRow: '1', width: '100%' }}>
        <div style={{ position: 'absolute', top: '-12px', left: '22px', width: '38px', height: '38px', background: 'linear-gradient(135deg, #c79a4a, #d4af6a)', borderRadius: '50%', display: 'flex', alignItems: 'center', justifyContent: 'center', boxShadow: '0 5px 15px rgba(199, 154, 74, 0.4)', animation: 'pulse 3s ease-in-out infinite' }}>
          <svg width="18" height="18" viewBox="0 0 24 24" fill="white">
            <path d="M12 2l3.09 6.26L22 9.27l-5 4.87 1.18 6.88L12 17.77l-6.18 3.25L7 14.14 2 9.27l6.91-1.01L12 2z" />
          </svg>
        </div>
        <div style={{ marginTop: '20px' }}>
          <h3 style={{ fontSize: '18px', fontWeight: 700, color: '#1a1a1a', marginBottom: '8px', fontFamily: "'Playfair Display', serif" }}> Personalized Curation </h3>
          <p style={{ fontSize: '14px', color: '#4a4a4a', lineHeight: '1.5', margin: 0 }}> Tailored to your taste & investment vision, every property is hand-selected for your unique lifestyle. </p>
        </div>
      </div>

      {/* Card 2 - Row 1, Column 3 */}
      <div className="floating-card" style={{ background: 'linear-gradient(135deg, #ffffff 0%, #fefefe 100%)', padding: '45px 38px', borderRadius: '22px', boxShadow: '0 18px 45px rgba(0, 0, 0, 0.1), 0 10px 25px rgba(199, 154, 74, 0.2)', border: '1px solid rgba(199, 154, 74, 0.25)', position: 'relative', transform: 'translateY(-15px)', transition: 'all 0.4s cubic-bezier(0.4, 0, 0.2, 1)', zIndex: 3, gridColumn: '3', gridRow: '1', width: '100%' }}>
        <div style={{ position: 'absolute', top: '-12px', left: '22px', width: '38px', height: '38px', background: 'linear-gradient(135deg, #c79a4a, #d4af6a)', borderRadius: '50%', display: 'flex', alignItems: 'center', justifyContent: 'center', boxShadow: '0 5px 15px rgba(199, 154, 74, 0.4)', animation: 'pulse 3s ease-in-out infinite 0.5s' }}>
          <svg width="18" height="18" viewBox="0 0 24 24" fill="white">
            <path d="M12 2C6.48 2 2 6.48 2 12s4.48 10 10 10 10-4.48 10-10S17.52 2 12 2zm-2 15l-5-5 1.41-1.41L10 14.17l7.59-7.59L19 8l-9 9z" />
          </svg>
        </div>
        <div style={{ marginTop: '20px' }}>
          <h3 style={{ fontSize: '18px', fontWeight: 700, color: '#1a1a1a', marginBottom: '8px', fontFamily: "'Playfair Display', serif" }}> Elite Developer Network </h3>
          <p style={{ fontSize: '14px', color: '#4a4a4a', lineHeight: '1.5', margin: 0 }}> Exclusive partnerships across premium developers in Pune & Hyderabad region. </p>
        </div>
      </div>

      {/* Card 3 - Row 1, Column 4 */}
      <div className="floating-card" style={{ background: 'linear-gradient(135deg, #ffffff 0%, #fefefe 100%)', padding: '45px 38px', borderRadius: '22px', boxShadow: '0 18px 45px rgba(0, 0, 0, 0.1), 0 10px 25px rgba(199, 154, 74, 0.2)', border: '1px solid rgba(199, 154, 74, 0.25)', position: 'relative', transform: 'translateY(15px)', transition: 'all 0.4s cubic-bezier(0.4, 0, 0.2, 1)', zIndex: 3, gridColumn: '4', gridRow: '1', width: '100%' }}>
        <div style={{ position: 'absolute', top: '-12px', left: '22px', width: '38px', height: '38px', background: 'linear-gradient(135deg, #c79a4a, #d4af6a)', borderRadius: '50%', display: 'flex', alignItems: 'center', justifyContent: 'center', boxShadow: '0 5px 15px rgba(199, 154, 74, 0.4)', animation: 'pulse 3s ease-in-out infinite 1s' }}>
          <svg width="18" height="18" viewBox="0 0 24 24" fill="white">
            <path d="M9 12l2 2 4-4m6 2a9 9 0 11-18 0 9 9 0 0118 0z" />
          </svg>
        </div>
        <div style={{ marginTop: '20px' }}>
          <h3 style={{ fontSize: '18px', fontWeight: 700, color: '#1a1a1a', marginBottom: '8px', fontFamily: "'Playfair Display', serif" }}> Complete Transparency </h3>
          <p style={{ fontSize: '14px', color: '#4a4a4a', lineHeight: '1.5', margin: 0 }}> No hidden costs, no inflated numbers. Pure, honest dealings with crystal-clear pricing. </p>
        </div>
      </div>

      {/* Card 4 - Row 2, Column 2 */}
      <div className="floating-card" style={{ background: 'linear-gradient(135deg, #ffffff 0%, #fefefe 100%)', padding: '45px 38px', borderRadius: '22px', boxShadow: '0 18px 45px rgba(0, 0, 0, 0.1), 0 10px 25px rgba(199, 154, 74, 0.2)', border: '1px solid rgba(199, 154, 74, 0.25)', position: 'relative', transform: 'translateY(0)', transition: 'all 0.4s cubic-bezier(0.4, 0, 0.2, 1)', zIndex: 3, gridColumn: '2', gridRow: '2', width: '100%' }}>
        <div style={{ position: 'absolute', top: '-12px', left: '22px', width: '38px', height: '38px', background: 'linear-gradient(135deg, #c79a4a, #d4af6a)', borderRadius: '50%', display: 'flex', alignItems: 'center', justifyContent: 'center', boxShadow: '0 5px 15px rgba(199, 154, 74, 0.4)', animation: 'pulse 3s ease-in-out infinite 1.5s' }}>
          <svg width="18" height="18" viewBox="0 0 24 24" fill="white">
            <path d="M12 21.35l-1.45-1.32C5.4 15.36 2 12.28 2 8.5 2 5.42 4.42 3 7.5 3c1.74 0 3.41.81 4.5 2.09C13.09 3.81 14.76 3 16.5 3 19.58 3 22 5.42 22 8.5c0 3.78-3.4 6.86-8.55 11.54L12 21.35z" />
          </svg>
        </div>
        <div style={{ marginTop: '20px' }}>
          <h3 style={{ fontSize: '18px', fontWeight: 700, color: '#1a1a1a', marginBottom: '8px', fontFamily: "'Playfair Display', serif" }}> End-to-End Support </h3>
          <p style={{ fontSize: '14px', color: '#4a4a4a', lineHeight: '1.5', margin: 0 }}> From search to keys, we guide you through every step of your property journey. </p>
        </div>
      </div>

      {/* Card 5 - Row 2, Column 3 (Centered) */}
      <div className="floating-card central-card" style={{ background: 'linear-gradient(135deg,rgb(255, 255, 255) 0%,rgb(255, 255, 255) 100%)', padding: '50px 42px', borderRadius: '24px', boxShadow: '0 20px 50px rgba(0, 0, 0, 0.12), 0 12px 28px rgba(199, 154, 74, 0.25)', border: '2px solid rgba(199, 154, 74, 0.3)', position: 'relative', transform: 'scale(1.03)', zIndex: 4, margin: '20px auto', gridColumn: '3', gridRow: '2', width: '100%' }}>
        <div style={{ position: 'absolute', top: '-12px', left: '22px', width: '38px', height: '38px', background: 'linear-gradient(135deg, #c79a4a, #d4af6a)', borderRadius: '50%', display: 'flex', alignItems: 'center', justifyContent: 'center', boxShadow: '0 5px 15px rgba(199, 154, 74, 0.4)', animation: 'pulse 3s ease-in-out infinite 1.5s' }}>
        ...
        <div>
          <h3 style={{ fontSize: '22px', fontWeight: 700, color: 'black', marginBottom: '12px', fontFamily: "'Playfair Display', serif" }}> Investment-Led Advisory </h3>
          <p style={{ fontSize: '16px', color: 'black', lineHeight: '1.5', margin: 0 }}> Data-driven insights on growth potential, rental yields & market appreciation trends. </p>
        </div>
      </div>
    </div>
    ...
    {/* Bottom Quote */}
    <div style={{ textAlign: 'center', marginTop: '50px', position: 'relative' }}>
      <div style={{ display: 'inline-block', padding: '20px 35px', background: 'rgba(255, 255, 255, 0.8)', borderRadius: '16px', border: '1px solid rgba(199, 154, 74, 0.2)', boxShadow: '0 10px 25px rgba(0, 0, 0, 0.08)', backdropFilter: 'blur(10px)' }}>
        <p style={{ fontSize: '16px', color: '#1a1a1a', fontStyle: 'italic', fontWeight: 500, margin: 0, fontFamily: "'Playfair Display', serif" }}> "Luxury begins with clarity. We deliver both." </p>
      </div>
    </div>
  </div>
</section>
